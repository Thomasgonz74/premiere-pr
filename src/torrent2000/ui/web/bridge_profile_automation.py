...
bandwidth schedule, watch folder, disk-space warning, auto-shutdown, and
pause-on-battery. Mirrors BandwidthScheduleSection/WatchFolderSection/
DiskSpaceSection/AutoShutdownSection/BatteryPauseSection in
